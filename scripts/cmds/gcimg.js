...
module.exports = {
    ...
    onStart: async function ({ api, args, event, message }) {
        try {
            let color = "red", bgColor = "", adminColor = "yello", memberColor = "cyan", nameColor = "white";
    ...
    switch (args[i]) {
        ...
        case "--namecolor": 
            ...
            const { data } = await axios.post('https://noobs-gcimg.onrender.com/groupPhoto', data2);
