...
module.exports = {
  ...
  onStart: async function ({ event, message, usersData, api, args }) {
    try {
      ...
      const audiobody = `
     𝐀 𝐫𝐚𝐧𝐝𝐨𝐦 𝐚𝐧𝐢𝐦𝐞 𝐪𝐮𝐢𝐳 𝐪𝐮𝐞𝐬𝐭𝐢𝐨𝐧 𝐡𝐚𝐬 𝐚𝐩𝐩𝐞𝐚𝐫𝐞𝐝! 𝐆𝐮𝐞𝐬𝐬 𝐭𝐡𝐞 𝐚𝐧𝐢𝐦𝐞 𝐧𝐚𝐦𝐞. \n
      𝐓𝐫𝐚𝐢𝐭𝐬: ${traits}
      𝐓𝐚𝐠𝐬: ${tags}
      `;
  ...
  onReply: async function ({ message, event, Reply, api }) {
    try {
      ...
      if (correctAnswers.includes(userAnswer)) {
        ...
        await message.reply("✅ | 𝐂𝐨𝐫𝐫𝐞𝐜𝐭 𝐚𝐧𝐬𝐰𝐞𝐫! 𝐘𝐨𝐮 𝐡𝐚𝐯𝐞 𝐞𝐚𝐫𝐧𝐞𝐝 𝟒𝟔𝟎 𝐜𝐨𝐢𝐧𝐬 𝐚𝐧𝐝 𝟏𝟐𝟏 𝐞𝐱𝐩.");
        ...
        await message.reply(`❌ | 𝐖𝐫𝐨𝐧𝐠 𝐚𝐧𝐬𝐰𝐞𝐫! 𝐘𝐨𝐮 𝐥𝐨𝐬𝐭 𝟑𝟎𝟎 𝐜𝐨𝐢𝐧𝐬 & 𝟏𝟐𝟏 𝐞𝐱𝐩.\n 𝐓𝐡𝐞 𝐜𝐨𝐫𝐫𝐞𝐜𝐭 𝐚𝐧𝐬𝐰𝐞𝐫 𝐰𝐚𝐬:\n${Reply.correctAnswer.join(" or ")}`);
      }
