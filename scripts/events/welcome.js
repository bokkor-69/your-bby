...
module.exports = {
	...
	langs: {
		...
		en: {
			...
			session3: "afternoon",
			session4: "evening",
			welcomeMessage: "ᴛᴏᴍ ʙʙʏ 𝙲𝚘𝚗𝚗𝚎𝚌𝚝𝚎𝚍 𝚂𝚞𝚌𝚌𝚎𝚜𝚜𝚏𝚞𝚕𝚕𝚢 🐝\n\n𝖧𝖾𝗅𝗅𝗈 😻\n𝖧𝖾𝗋𝖾'𝗌 𝗆𝗒 𝗉𝗋𝖾𝖿𝗂𝗑 ( {prefix} )\n𝖴𝗌𝖾 ( {prefix}𝖧𝖾𝗅𝗉 ) 𝗍𝗈 𝗌𝖾𝖾 𝖺𝗏𝖺𝗂𝗅𝖺𝖻𝗅𝖾 𝖼𝗈𝗆𝗆𝖺𝗇𝖽𝗌.\n𝖧𝖾𝗋𝖾'𝗌 𝗆𝗒 𝗈𝗐𝗇𝖾𝗋 𝗇𝖺𝗆𝖾 ʙᴏᴋᴋᴏʀ\n𝖴𝗌𝖾 {prefix}𝖢𝖺𝗅𝗅𝖺𝖽 𝖿𝗈𝗋 𝖺𝗇𝗒 𝗍𝖾𝖼𝗁𝗇𝗂𝖼𝖺𝗅 𝖾𝗋𝗋𝗈𝗋𝗌 𝗈𝗋 𝖼𝗈𝗇𝗍𝖺𝖼𝗍 𝗆𝖾 𝗈𝗇 𝗌𝗈𝖼𝗂𝖺𝗅 𝗆𝖾𝖽𝗂𝖺:  https://www.facebook.com/ewr.bokkor \n\n 🦋",
			multiple1: "you",
			multiple2: "you guys",
